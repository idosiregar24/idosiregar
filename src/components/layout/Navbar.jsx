    ...
    <nav className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4 md:px-8">
      <div className="w-full max-w-4xl apple-glass rounded-full flex justify-between items-center p-2 pl-6">
        ...
        <div 
          ...
          className="flex items-center gap-3 select-none cursor-pointer pr-4"
        >
        ...
        <div className="hidden lg:flex items-center gap-2">
          {(settings.nav_items || []).map((item) => (
            <button
              ...
              className="text-[13px] font-semibold transition-all px-4 py-2 rounded-full text-white/50 hover:text-white hover:bg-white/5"
            >
              {item.label}
            </button>
          ))}
        ...
        {settings.action_button && (
          <div className="hidden lg:flex items-center">
            <button 
              ...
              className="bg-white text-black px-6 py-2.5 rounded-full font-semibold text-[13px] transition-transform active:scale-95 shadow-sm hover:shadow-md cursor-pointer"
            >
        ...
        {/* Mobile Menu Toggle */}
        <button
          className="lg:hidden w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-white/70 hover:text-white hover:bg-white/10 transition-all ml-auto cursor-pointer"
      ...
      >
        <div className="absolute top-[80px] left-4 right-4 apple-glass-heavy rounded-3xl p-4 shadow-2xl lg:hidden max-w-sm mx-auto">
